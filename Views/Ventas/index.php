                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" id="codigo" class="form-control form-control-sm" 
                                   placeholder="Código" onkeyup="buscarCodigoVentas(event)">
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="cantidad" id="cantidad" class="form-control form-control-sm" 
                                   placeholder="Cant" onchange="calcularPrecioVenta(event)" 
                                   onkeyup="calcularPrecioVenta(event)" disabled>
                        </div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                        <div class="form-group">
                    ...
                    <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="precio_bolos" id="precio_bolos" class="form-control form-control-sm" 
                                   placeholder="BsD 0.00" disabled>
                        </div>
                    </div>
                </div>
                
                <!-- Segunda fila: Subtotales -->
                <div class="row g-2">
                    <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                        <div class="form-group">
            ...
            <div class="col-12 col-md-6 col-lg-8">
                <div class="row g-2">
                    <div class="col-12 col-sm-8 col-md-10 col-lg-6">
                        <div class="form-group">
                            <label for="cliente" class="form-label small fw-bold">Seleccionar Cliente</label>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="row g-2 justify-content-end">
                    ...
                    <div class="col-12 col-sm-4 col-md-12 col-lg-12">
                        <button type="button" class="btn btn-primary btn-sm w-100 mt-2" onclick="generarVenta()">
                            <i class="fas fa-cash-register me-1"></i> Generar Venta
                        </button>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="detalleMovilModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body" id="detalleMovilContent">
                <!-- Contenido dinámico -->
            </div>
        </div>
    </div>
